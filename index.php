            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="text-center text__about_us">
                        ...
                        <p>Мы предоставляем услуги ногтевого сервиса. Наши мастера владеют разными техниками и
                            работают профессиональными материалами.
                            Материалы европейского качества обеспечивают длительную носку и ухоженный вид маникюра,а
                            также безопасны для вас.</p>
                        <div class="collapse" id="collapseExample">
                            <p>Мы предлагаем широкую палитру цветов и разнообразие дизайнов. Инструменты в нашей
                                студии проходят все этапы дезинфекции и стерилизации (сухожар).</p>
                            <p>При клиенте вскрывается стерильный пакет с комплектом инструментов, а также
                                используем одноразовые расходные материалы.
                                Мы работаем на профессиональном оборудовании, что позволяет сократить время
                                процедуры.
                                Вас всегда ожидает тёплая атмосфера - мы предложим Вам фильм, wi-fi и чашечку
                                кофе.</p>
                        </div>
                        <div id="btn-main1">
                ...
                <div class="col-md-4 col-sm-12 img-col1">
                    <div class="father">
                        ...
                        <div class="text__on-block">
                            ...
                            <div><p class="dependent__text__two">Коррекция/укрепление гелевой системой, маникюр и
                                    покрытие</p></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col subheder-col" id="btn-main2">
                    <button type="button" class="btn btn-primary button__more-price" id="next__nails"
                            data-toggle="modal" data-target=".bd-example-modal-lg">Подробный прайс
                    </button>
                </div>
            </div>
        </div>
    ...
    <section>
        ...
        <div class="outer__container">
            <div class="owl-carousel owl-theme">
                <div class="overflow">
                    <div><a class="fancybox" rel="group" href="img/nail_1.jpg"><img src="img/nail_1.jpg"
                                                                                    class="photo__gallery" alt=""></a>
                    </div>
                </div>
                <div class="overflow">
                    <div><a class="fancybox" rel="group" href="img/nail_2.jpg"><img src="img/nail_2.jpg"
                                                                                    class="photo__gallery" alt=""></a>
                    </div>
                </div>
                <div class="overflow">
                    <div><a class="fancybox" rel="group" href="img/nail_3.jpg"><img src="img/nail_3.jpg"
                                                                                    class="photo__gallery" alt=""></a>
                    </div>
                </div>
                <div class="overflow">
                    <div><a class="fancybox" rel="group" href="img/nail_4.jpg"><img src="img/nail_4.jpg"
                                                                                    class="photo__gallery" alt=""></a>
                    </div>
                </div>
                <div class="overflow">
                    <div><a class="fancybox" rel="group" href="img/nail_5.jpg"><img src="img/nail_5.jpg"
                                                                                    class="photo__gallery" alt=""></a>
                    </div>
                </div>
                <div class="overflow">
                    <div><a class="fancybox" rel="group" href="img/nail_6.jpg"><img src="img/nail_6.jpg"
                                                                                    class="photo__gallery" alt=""></a>
                    </div>
                </div>
                <div class="overflow">
                    <div><a class="fancybox" rel="group" href="img/nail_7.jpg"><img src="img/nail_7.jpg"
                                                                                    class="photo__gallery" alt=""></a>
                    </div>
                </div>
                <div class="overflow">
                    <div><a class="fancybox" rel="group" href="img/nail_8.jpg"><img src="img/nail_8.jpg"
                                                                                    class="photo__gallery" alt=""></a>
                    </div>
                </div>
            </div>
        ...
        <div id="cont-button">
            <div class="row">
                <div class="col-sm-12" id="btn-main3">
                    <a class="click-me" href="photo__nails.html">
                        <button class='btn btn-outline-primary button__more-nails'>Больше работ</button>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div id="insta">
            <div class="row">
                <div class="col-sm-12" id="inst">
                    <h3>Подпишись на нас в инстаграм <a href="https://www.instagram.com/malinnastudio/" target="_blank"><img
                                    class="subscribe__icon" src="img/insta__icon_big.png" alt=""></a></h3>
                </div>
            </div>
            ...
            <div class="row" style="margin:0;">
                ...
                <div class="col-md-4 col-sm-12 adress">
                    ...
                    <div class="adress__content">
                        ...
                        <a href="https://www.instagram.com/malinnastudio/" target="_blank"><p
                                    class="malinastudio__insta"></a><a href="https://www.instagram.com/malinnastudio/"
                                                                       target="_blank"><i>malinastudio</i><img
                                    class="malinastudio" src="img/insta__icon.png" alt=""></p></a>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-12 f-3">
                    <div id="map">
                        <div class="contacts_map">
                            <iframe width="" height=""
                                    src="https://maps.google.com/maps?q=%D0%96%D0%9A%20%22%D0%A1%D0%BE%D1%84%D0%B8%D1%8F%22%20%D1%83%D0%BB.%20%D0%9B.%20%D0%A3%D0%BA%D1%80%D0%B0%D0%B8%D0%BD%D0%BA%D0%B8%2C6+(%D0%9C%D0%B0%D0%BB%D0%B8%D0%BD%D0%BD%D0%B0)&amp;ie=UTF8&amp;t=&amp;z=15&amp;iwloc=B&amp;output=embed"
...
<footer class="probootstrap-footer malinna__footer">
    <div class="container-fluid" id="inst-cont__footer">
        <div class="container text-center">
            <div class="row">
                <div class="col-sm-12">
                    <div class="malinna__copyright"><p>© Студия ногтевого сервися “Малинна”. 2019. Все права
                            защищены</p></div>
                </div>
            </div>
        </div>
